...
export default function Login() {
  ...
  if (!navigating && access_token && user) return <Navigate to="/" replace />;
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-100 dark:bg-[#0d1117] px-4 py-8">
      <div className="flex flex-col md:flex-row w-full max-w-sm md:max-w-4xl rounded-3xl overflow-hidden shadow-2xl shadow-slate-900/20">
        <div className="hidden md:flex flex-1 flex-col items-center justify-between py-10 px-8 relative overflow-hidden bg-[#0F172A]">
          <div
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 40% 35%, rgba(99,102,241,0.22) 0%, transparent 60%), linear-gradient(to bottom, transparent 55%, #0F172A 100%)",
            }}
          />
          ...
          <div className="relative z-10 flex items-center">
            ...
            <p className="text-white font-bold text-xl">
              Hệ thống Đặt hàng
              <br />
              <span className="text-[#818CF8]">"Good"s Shop</span>
            </p>
          </div>

          <div className="relative z-10 w-full max-w-65">
            <Player autoplay loop src={loadingAnimation} className="w-full" />
          </div>
        ...
        <div className="flex md:hidden flex-col items-center justify-center py-4 px-4 gap-3 relative overflow-hidden bg-[#0F172A]">
          <div
            className="absolute inset-0 pointer-events-none"
            style={{
              backgroundImage:
          ...
          <div className="relative z-10 flex flex-col items-center gap-3">
            <div className="flex items-center gap-4">
              <img src={Logo} className="w-35 h-35 object-contain" />
              <Player autoplay loop src={loadingAnimation} className="w-40" />
            </div>
        ...
        <div className="w-full md:w-100 flex flex-col justify-center bg-white dark:bg-[#1c2333] px-8 sm:px-10 py-10 sm:py-14">
          ...
          <form onSubmit={handleSubmit} noValidate>
                ...
                <input
                  ...
                  className={`${inputBaseClass} ${
                    errors.email
                      ...
                      : "border-slate-200 dark:border-[#30363d] focus:border-[#6366F1] focus:ring-[#6366F1]/20"
                  }`}
                />
              </div>
            </FormField>
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-1 mb-2 md:mt-4 w-full h-11 rounded-xl font-semibold text-sm text-white bg-[#6366F1] flex items-center justify-center gap-2 transition-opacity disabled:opacity-70 disabled:cursor-not-allowed hover:opacity-95 cursor-pointer"
            >
          ...
          <div className="mt-1 md:mt-4 flex items-center justify-center gap-1.5">
            <span className="text-[14px] text-slate-300 dark:text-[#5a6478]">
              "Good"s Shop của Tuyết Dziii
            </span>
          </div>
        </div>
      </div>
